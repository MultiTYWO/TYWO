...
function main()
{
	...
	var cch = function(ev){
		canvasClickHandler(ev, ctx, cw, ch, character1, character2, balas, boarder, pocoes, buttons, variables, som, som2);	
	}
...
function init(canvas, ctx, cw, ch, character1, character2, balas, boarder, pocoes, buttons, variables)
{
	...
	variables.passosT = 0;
	variables.passosF = 0;
	variables.passosD2 = 0;
	variables.passosE2 = 0;
	variables.passosT2 = 0;
	variables.passosF2 = 0;
	...
	boarder[0] = new Board(cw, ch, variables.larguraBoarder, null);
...
function draw(ctx, cw, ch, character1, character2, balas, boarder, pocoes, buttons, variables)
{
	...
	if(character1[0].help == true){
		buttons[4].draw(ctx);
  		ctx.font = "bold 35px bloodFont";
	  	ctx.fillText("Use the arrow keys to move and space to shot on Player2", cw/2-5, ch/2 - 70);
	  	ctx.fillText("Use A,W,S,D to move and enter to shot on Player1", cw/2-5, ch/2 - 10);
	    ...
	    var segundos = Math.floor(dt/1000);
	  	...
	  	character1[0].segundos = (segundos-minutos*60);
...
{	
	...
	if(character1[0].paused != true && character1[0].help != true){
...
function render(ev, ctx, character1, character2, balas, boarder, pocoes, buttons, variables, reqID)
{
	...
	if(character1[0].vida == 0 || character2[0].vida == 0){
		...
		if(character1[0].left == true){
			...
			//variables.passosE++;
			if(variables.passosE >= 0 && variables.passosE < 10){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "E.png";
			}
			else if(variables.passosE >= 10 && variables.passosE < 20){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "E2.png";
			}
			else if(variables.passosE >= 20 && variables.passosE < 30){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "E3.png";
			}
			else{
				variables.passosE = 0;
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "E.png";
		...
		if(character1[0].top == true){
			...
			//variables.passosT++;
			character1[0].img = img;
			if(variables.passosT >= 0 && variables.passosT < 10){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "T.png";
			}
			else if(variables.passosT >= 10 && variables.passosC < 20){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "T2.png";
			}
			else if(variables.passosT >= 20 && variables.passosC < 30){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "T3.png";
			}
			else{
				variables.passosT = 0;
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "T.png";
		...
		if(character1[0].right == true){
			...
			//variables.passosD++;
			character1[0].img = img;
			if(variables.passosD >= 0 && variables.passosD < 10){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "D.png";
			}
			else if(variables.passosD >= 10 && variables.passosD < 20){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "D2.png";
			}
			else if(variables.passosD >= 20 && variables.passosD < 30){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "D3.png";
			}
			else{
				variables.passosD = 0;
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "D.png";
		...
		if(character1[0].bottom == true){
			...
			//variables.passosF++;
			character1[0].img = img;
			if(variables.passosF >= 0 && variables.passosF < 10){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "F.png";
			}
			else if(variables.passosF >= 10 && variables.passosF < 20){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "F2.png";
			}
			else if(variables.passosF >= 20 && variables.passosF < 30){
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "F3.png";
			}
			else{
				variables.passosF = 0;
				img.src = "../resources/"+ localStorage.getItem("player1Type") + "F.png";
		...
		if(character2[0].left == true){
			...
			//variables.passosE++;
			if(variables.passosE2 >= 0 && variables.passosE2 < 10){
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "E.png";
			}
			else if(variables.passosE2 >= 10 && variables.passosE2 < 20){
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "E2.png";
			}
			else if(variables.passosE2 >= 20 && variables.passosE2 < 30){
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "E3.png";
			}
			else{
				variables.passosE2 = 0;
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "E.png";
		...
		if(character2[0].top == true){
			...
			//variables.passosT++;
			character2[0].img = img;
			if(variables.passosT2 >= 0 && variables.passosT2 < 10){
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "T.png";
			}
			else if(variables.passosT >= 10 && variables.passosT < 20){
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "T2.png";
			}
			else if(variables.passosT >= 20 && variables.passosT < 30){
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "T3.png";
			}
			else{
				variables.passosT = 0;
				img.src = "../resources/"+ localStorage.getItem("player2ype") + "T.png";
			}
		...
		if(character2[0].right == true){
			...
			//variables.passosD++;
			character2[0].img = img;
			if(variables.passosD2 >= 0 && variables.passosD2 < 10){
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "D.png";
			}
			else if(variables.passosD2 >= 10 && variables.passosD2 < 20){
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "D2.png";
			}
			else if(variables.passosD2 >= 20 && variables.passosD2 < 30){
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "D3.png";
			}
			else{
				variables.passosD2 = 0;
				img.src = "../resources/"+ localStorage.getItem("player2Type") + "D.png";
		...
		if(character2[0].bottom == true){
			...
			//variables.passosF++;
			character2[0].img = img;
			if(variables.passosF2 >= 0 && variables.passosF2 < 10){
				img.src = "../resources/"+ localStorage.getItem("playerType") + "F.png";
			}
			else if(variables.passosF2 >= 10 && variables.passosF2 < 20){
				img.src = "../resources/"+ localStorage.getItem("playerType") + "F2.png";
			}
			else if(variables.passosF2 >= 20 && variables.passosF2 < 30){
				img.src = "../resources/"+ localStorage.getItem("playerType") + "F3.png";
			}
			else{
				variables.passosF2 = 0;
				img.src = "../resources/"+ localStorage.getItem("playerType") + "F.png";
...
function canvasClickHandler(ev, ctx, cw, ch, character1, character2, balas, boarder, pocoes, buttons, variables, som)
{
	...
	{
		if(character1[0].help == true){
			character1[0].help = false;
			startAnim(ev, ctx, cw, ch, character1, character2, balas, boarder, pocoes, buttons, variables);
		}
		else{
			character1[0].help = true;
		}
		return;
	}
}
