...
function wingame(ctx, cw, ch, spArray, buttons, boarder, variables){
	...
	ctx.font = "bold 40px bloodFont";
  	...
  	else if(boarder[0].nivelCriado || arrayNames[i].sequenciaNiveis == false){
  		//finish game
  		ctx.font = "bold 80px bloodFont";
  		ctx.fillText("You finish the level!", cw/2 - 10, ch/2 + 130);
  	}
  	else{
  		//finish game
  		ctx.fillStyle ="#330000" ;
  		ctx.font = "bold 70px bloodFont";
  		ctx.fillText("You finish all the levels!", cw/2 + 10, ch/2 + 140);
  	}
	...
	if(spArray[0].vida == 0){
		...
		if(spArray[0].left == true){
			...
			if(variables.passosE >= 0 && variables.passosE < 10){
				...
				img.src = "../resources/"+ localStorage.getItem("playerType") + "E2.png";
			}
			else if(variables.passosE >= 20 && variables.passosE < 30){
				img.src = "../resources/"+ localStorage.getItem("playerType") + "E3.png";
			}
			else{
				variables.passosE = 0;
				img.src = "../resources/"+ localStorage.getItem("playerType") + "E.png";
		...
		if(spArray[0].top == true){
			...
			if(variables.passosT >= 0 && variables.passosT < 10){
				...
				img.src = "../resources/"+ localStorage.getItem("playerType") + "T2.png";
			}
			else if(variables.passosT >= 20 && variables.passosC < 30){
				img.src = "../resources/"+ localStorage.getItem("playerType") + "T3.png";
			}
			else{
				variables.passosT = 0;
				img.src = "../resources/"+ localStorage.getItem("playerType") + "T.png";
		...
		if(spArray[0].right == true){
			...
			if(variables.passosD >= 0 && variables.passosD < 10){
				...
				img.src = "../resources/"+ localStorage.getItem("playerType") + "D2.png";
			}
			else if(variables.passosD >= 20 && variables.passosD < 30){
				img.src = "../resources/"+ localStorage.getItem("playerType") + "D3.png";
			}
			else{
				variables.passosD = 0;
				img.src = "../resources/"+ localStorage.getItem("playerType") + "D.png";
